...
Component({
  ...
  methods: {
    ...
    moveLeft(e) {
      ...
      const {dataset} = e.currentTarget
      const {scrollLeft, data} = this.data
      console.log('l', data[dataset.index].x)
